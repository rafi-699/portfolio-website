<?php
/**
 * index.php — Blog Index (Secure, with featured images)
 */
...
<head>
  ...
  <title>Blog - SM Rafi</title>
  <meta name="description" content="Insights on AI Innovation, Digital Marketing, and Entrepreneurship by SM Rafi">
        ...
        <div class="container">
            <div class="header__content">
                ...
                <nav class="header__nav">
                    <ul class="nav-list">
                        <li><a href="../#hero" class="nav-link">SM Rafi</a></li>
  ...
  <main class="main-content">
    <div class="container">
      <header class="blog-header">
        <h1 class="blog-title">SM Rafi Blog</h1>
        <p class="blog-subtitle">Insights on AI Innovation, Digital Marketing, and Entrepreneurship</p>
      </header>
            ...
            <article class="blog-card">
              <?php if (!empty($post['image_url'])): ?>
                <div class="blog-card__image">
                  <img src="<?php echo htmlspecialchars($post['image_url'], ENT_QUOTES); ?>"
              ...
              <div class="blog-card__content">
                ...
                <div class="blog-card__date"><?php echo $date; ?></div>
                <p class="blog-card__excerpt"><?php echo $excerpt; ?></p>
                <a href="post_<?php echo $post['id']; ?>.php" class="blog-card__link">Read More</a>
              </div>
            </article>
          <?php endforeach; ?>
        <?php else: ?>
